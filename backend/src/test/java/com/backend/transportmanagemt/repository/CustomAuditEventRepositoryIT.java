...
import com.backend.transportmanagemt.TransportmanagementApp;

import com.backend.transportmanagemt.config.Constants;
import com.backend.transportmanagemt.config.audit.AuditEventConverter;
import com.backend.transportmanagemt.domain.PersistentAuditEvent;
...
import static com.backend.transportmanagemt.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = TransportmanagementApp.class)
@Transactional
